...
namespace FanControl.Liquidctl
{
    internal class LiquidctlDevice
    {
        ...
        public class MicroFanControl : IPluginControlSensor
        {
            public MicroFanControl(LiquidctlStatusJSON output)
            {
                _address = output.address;
                _id = $"{output.address}-fanctrl";
        ...
        public LiquidctlDevice(LiquidctlStatusJSON output, IPluginLogger pluginLogger)
        {
            ...
            if (hasMicroFanSpeed) {
                ...
                microFanControl = new MicroFanControl(output);
            }
        ...
        public MicroFanControl microFanControl;
